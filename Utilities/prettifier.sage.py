...
_sage_const_1 = Integer(1); _sage_const_3 = Integer(3); _sage_const_7 = Integer(7); _sage_const_2 = Integer(2); _sage_const_5 = Integer(5); _sage_const_8 = Integer(8)# Credit to dsejas on ask.sagemath.org
...
expr = _sage_const_3 /_sage_const_7 *sqrt(_sage_const_2 )*sqrt(pi)*(_sage_const_5 )**(_sage_const_8 /_sage_const_7 ) + _sage_const_2 
